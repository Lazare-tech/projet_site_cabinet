...
<div lc-helper="background" class="container-fluid py-5 mb-4 d-flex justify-content-center hero_acc">
        <div class="p-5 mb-4 lc-block col-xxl-7 col-lg-8 col-12" style=" backdrop-filter: blur(6px) saturate(102%);
            ...
            <div class="lc-block col-md-8 col-xs-12">
                <div editable="rich">
                    <p class="card-text">
                    Plongez dans l'univers de nos services de fiscalité et découvrez comment notre expertise peut faire une réelle différence dans la gestion de vos affaires financières. Nous comprenons que la fiscalité est un élément essentiel de toute stratégie commerciale réussie, et c'est pourquoi nous offrons une gamme complète de services personnalisés conçus pour répondre à vos besoins spécifiques.
                    </p>
                </div>
            </div>
            <div class="lc-block">
